...
use gpui::{actions, App, Entity, EventEmitter, FocusHandle, Focusable, ScrollHandle};
use ui::prelude::*;
...
impl Render for SettingsPage {
    fn render(&mut self, window: &mut Window, _cx: &mut Context<Self>) -> impl IntoElement {
        let height = window.viewport_size().height - Pixels(100f32);
                ...
                v_flex()
                    ...
                    .child(
                        v_flex()
                            ...
                            .child(v_flex().child(AppearanceSettingsControls::new())),
                    )
                    .child(
                        v_flex()
                            .gap_1()
                            .child(Label::new("Editor"))
                            .child(v_flex().child(EditorSettingsControls::new())),
                    ),
            )
    }
}
